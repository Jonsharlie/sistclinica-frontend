...
export class AgregarEditarConsultaComponent {
  ...
  getConsulta(id: number) {
    ...
    this._consultaService.getConsulta(id).subscribe(data => {
  ...
  getEspecialidades() {
    this._especialidadService.getEspecialidades().subscribe(data => {
  ...
  getDoctores() {
    this._trabajadorService.getTrabajadoresPorCargo(2).subscribe(data => {
  ...
  addEditConsulta() {
    ...
    if (this.id == undefined) {
      ...
      this._consultaService.updateConsulta(this.id, consulta).subscribe(data => {
  ...
  searchPatient() {
    ...
    this._pacienteService.getPaciente(nro_historia).subscribe(data => {
